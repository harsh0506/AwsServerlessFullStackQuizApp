                    ...
                    <form class="w-full">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            ...
                            <div class="flex justify-between w-full px-3">
                                <button onClick={(e) => PostData(e)} class="shadow bg-indigo-600 hover:bg-indigo-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-6 rounded" type="submit">
                                    Send Message
                                </button>
                            </div>
